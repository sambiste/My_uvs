  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        ...
        labelName: 'Mon Profile',
        isAssetsImage: true,
        imageName: 'assets/images/user.webp',
      ),
      DrawerList(
      ...
      DrawerList(
          index: DrawerIndex.Bourse,
          labelName: 'Ma Bourse',
          icon: Icon(Icons.attach_money)
      ),
      DrawerList(
        index: DrawerIndex.Platform,
        labelName: 'Plateforme ',
              ...
              child: new Column(
                children: <Widget>[
                 CircleAvatar(
                   ...
                   new Text("Souleymane Diop"),
                  new Text("Souleymane.diop@uvs.edu.sn"),
                ],
              ),
            ),
          ),
